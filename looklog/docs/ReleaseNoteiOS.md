...
### v1.20.2
**💅改进：**
* 修复：穿搭日记中关联衣物无法持久化的问题（感谢@淳茵的反馈）

### v1.20.1
**💅改进：**
* 修复：首次添加衣物失败的问题（感谢@MIN、@喝喝的及时反馈）
...
**💅改进：**
* 优化：标签管理页面的交互方式，更方便地添加标签
* 优化：为增加穿着次数添加动画，反馈更明显
* 修复：通用标签组中的衣物无法按分类显示的问题
* 修复：橡皮擦路径有偏移问题

### v1.19.0
**🥳新功能：**
* 新增：标签组功能，更好地管理标签，清晰明了
* 新增：文件夹属性，试衣间可以新增“灵感”属性的文件夹，便于灵感照片分类
* 新增：断舍离页面支持显示控制，可配置显示单次成本、备注等
* 新增：是否默认移除穿搭日记背景的设置

**💅改进：**
* 优化：衣物详情页的标签支持收起、展开，避免拥挤、查找困难
* 优化：各处货币显示统一
* 优化：增加自动备份提示
* 优化：衣物详情页中更新图片，也符合是否“默认移除背景”的设置
* 修复：从衣物编辑页添加标签，标签管理页会自动收起的问题
* 修复：大量数据下，时间线切换页面的崩溃问题
...
**💅改进：**
* 修复：17.x iOS系统上试衣间添加按钮点击无效的问题

### v1.18.3
**💅改进：**
* 修复：iPad/Mac上试衣间添加按钮不显示的问题
* 修复：衣橱页面季节图标排序不统一的问题

### v1.18.2
**💅改进：**
* 优化：添加无法删除系统分类的提示，避免造成困惑
* 优化：标签筛选界面，避免标签显示不全
* 修复：重置筛选无法持久化的问题
* 修复：iPad、Mac上无法导入数据的问题

### v1.18.1
**💅改进：**
* 优化：确保时间线隐藏时，自定义分类在首次显示时就绪
* 优化：衣物选择器遵循“分类管理”的排序
* 优化：试衣间底部操作栏，避免被TabBar遮挡
* 修复：日历页缩略图背景显示异常的问题

### v1.18.0
**🥳新功能：**
* 新增：穿搭小组件，直接从桌面添加每日穿搭
* 新增：适配 Liquid glass 风格
* 新增：基础货币设置（显示设置）
* 新增：衣橱“全部分类统一显示”选项
* 新增：批量修改季节
* 新增：批量上传灵感图片
...
**💅改进：**
* 优化：照片详情页的关联衣物，可直接跳转到衣物详情页
* 优化：衣橱交互——搜索/多选固定在顶部
* 优化：列表模式下点击空白快速进入编辑
* 修复：断舍离后删除不生效的问题
* 修复：日历与穿搭详情页背景不同步的问题
* 修复：某些场景下使用橡皮擦可能导致的崩溃
